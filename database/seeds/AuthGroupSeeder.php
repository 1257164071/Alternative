...
class AuthGroupSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = [
            ...
            ['id' => 11, 'name' => '编辑角色', 'type' => 1, 'rule' => '/api/admin/role/*', 'action' => 'PUT', 'parent_id' => 3, 'guard' => 'admin'],
            ['id' => 12, 'name' => '编辑角色', 'type' => 1, 'rule' => '/api/admin/role/*', 'action' => 'DELETE', 'parent_id' => 3, 'guard' => 'admin'],
